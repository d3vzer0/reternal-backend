...
# Stop active agent
@router.get('/agents/{worker_name}/{agent_id}/stop', response_model=CeleryTask)
...
@router.get('/state/agents/stop/{job_uuid}', response_model=List[Dict])
...
@router.delete('/agents/{worker_name}/{agent_id}', response_model=CeleryTask)
