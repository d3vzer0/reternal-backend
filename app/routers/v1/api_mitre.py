...
@router.get('/mitre/technique/{technique_id}', response_model=AttckTechniquesOut)
...
@router.get('/mitre/phases', response_model=List[str])
...
@router.get('/mitre/datasources', response_model=List[str])
...
@router.get('/mitre/actor/{actor_name}', response_model=AttckActorOut)
...
@router.get('/products/coverage', response_model=CoverageOut)
...
@router.delete('/mitre/coverage/{coverage_id}', response_model=Dict[str, str])
...
@router.get('/mitre/coverage/{coverage_id}', response_model=CoverageOut)
...
@router.get('/mitre/aggregate/by_phase', response_model=List[AttckAggPhasesOut])
