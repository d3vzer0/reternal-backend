...
@router.get('/stagers/{worker_name}', response_model=CeleryTask)
...
async def create_stager(worker_name: str, listener_opts: dict = Body(...), context: dict = Depends(validate_worker), current_user: dict = Depends(decode_token)):
