...
from app.utils.depends import validate_search, decode_token, validate_token
...
@router.post('/search/{worker_name}/sourcetypes', response_model=TaskOut, dependencies=[Security(validate_token, scopes=['write:integrations'])])
...
@router.post('/search/{worker_name}/indices', response_model=TaskOut, dependencies=[Security(validate_token, scopes=['write:integrations'])])
